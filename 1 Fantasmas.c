...
{
    int temp = a->jugador->puntaje;
    a->jugador->puntaje = b->jugador->puntaje;
    b->jugador->puntaje = temp;
    char temp_nombre[50];
    strcpy(temp_nombre, a->jugador->nombre);
    strcpy(a->jugador->nombre, b->jugador->nombre);
    strcpy(b->jugador->nombre, temp_nombre);
}
...
void ordenarLista()
{
    ...
    do
    {
        ...
        {
            if (puntero->jugador->puntaje < puntero->siguiente->puntaje)
            {
...
void barraDeCarga()
{
    int xSup=21, ySup=16, xInf=92, yInf=18;
